...
// 		console.log(tm)
// 		$(this).html(tm.strftime('<span class="counter_box"><span  id="times_d"  class="tk_counter days"> </span><span class="tk_text">Days</span></span><span class="counter_box"><span id="times_h" class="tk_counter hours"></span><span class="tk_text">Hours</span></span><span class="counter_box"><span id="times_m" class="tk_counter minutes"></span><span class="tk_text">Minutes</span></span><span class="counter_box"><span class="tk_counter seconds" id="times_s"></span><span class="tk_text">Seconds</span></span>'));
// 	});
// });
$('.tk_countdown_time').each(function() {
	var endTime = $(this).data('time');
...
$('.tk_countdown_times').each(function() {

	var endTime = $(this).data('time');
	$(this).countdown(endTime, function(tm) {
		console.log(tm)
		$(this).html(tm.strftime('<span class="counter_box"><span  id="times_ds"  class="tk_counter days"> </span><span class="tk_text">Days</span></span><span class="counter_box"><span id="times_hs" class="tk_counter hours"></span><span class="tk_text">Hours</span></span><span class="counter_box"><span id="times_ms" class="tk_counter minutes"></span><span class="tk_text">Minutes</span></span><span class="counter_box"><span class="tk_counter seconds" id="times_ss"></span><span class="tk_text">Seconds</span></span>'));
	});
});
